              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Личные чаты и звонки идут напрямую между устройствами. '
                      'Мы не просим телефон и не храним сообщения на сервере. '
                      'В комнатах переписку видит организатор — это не '
                      'сквозное шифрование.',
                      style: TextStyle(
