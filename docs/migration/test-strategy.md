...
| 14 | Isolation table wired through `decideDualStack`; `_openChannel` / inbound PeerJS skip when `peerjsAllowedOnNative` is false; product mode `default-live` | Support window + removal |
