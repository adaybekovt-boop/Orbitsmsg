...
| 5 | Signed caps on native connect and PeerJS `wireHello.caps`; identity-signed `DeviceBinding.signedPayload` (`issueLocalDeviceBinding`); vault-wrapped discovery persist | Physical pair |
