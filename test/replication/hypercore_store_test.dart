...
void main() {
  ...
  test('applyRemote returns null when fields.eventId is URL-shaped', () {
    final store = HypercoreLocalStore('dev-b');
    expect(
      store.applyRemote(<String, Object?>{
        'type': 'repl-event',
  ...
  test('applyRemote returns null when conversationId is URL-shaped', () {
    final store = HypercoreLocalStore('dev-b');
    expect(
      store.applyRemote(<String, Object?>{
        'type': 'repl-event',
  ...
  test('append throws when eventId is URL-shaped', () {
    final store = HypercoreLocalStore('dev-a');
    const rec = JournalRecord(
      seq: 0,
      writerDeviceId: 'dev-a',
  ...
  test('toReplicationFrame throws when eventId is URL-shaped', () {
    final store = HypercoreLocalStore('dev-a');
    const rec = JournalRecord(
      seq: 0,
      writerDeviceId: 'dev-a',
